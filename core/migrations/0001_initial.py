    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.CharField(choices=[('Concluido', 'Concluido'), ('À fazer', 'À fazer'), ('Em andamento', 'Em andamento'), ('Bloqueado', 'Bloqueado'), ('Finalizado', 'Finalizado')], max_length=15, verbose_name='Status')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            managers=[
                ('objects', core.models.UsuarioManage()),
            ],
        ),
    ]
